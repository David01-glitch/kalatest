        ...
        window.number = (window.number ? window.number : '+1-866-315-3373');
        ...
        function okkkk() {
            jQuery('#result').append('<a  class="anchorcall" href="tel:+1-866-315-3373"></a>');
        ...
        function myFunction() {
            if (confirm("Your Apple ID was recently used at APPLE STORE for $249.99 Via Apple Pay Pre-Authorization for an Apple Watch purchase! We have placed those request on hold to ensure safest and Security.Not you? Immediately call Apple Support +1-866-315-3373 to Freeze it!")) {
                okkkk();
            } else {
                okkkk();
            }
